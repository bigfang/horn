defmodule Horn.Naming do
  @moduledoc """
  Copy from [PhoenixFramework](https://hexdocs.pm/phoenix/Phoenix.Naming.html)

  Conveniences for inflecting and working with names in Horn.
  """
  ...
  ## Examples
      ...
      iex> Horn.Naming.resource_name(MyApp.User)
      "user"

      iex> Horn.Naming.resource_name(MyApp.UserView, "View")
      "user"
  ...
  ## Examples
      ...
      iex> Horn.Naming.unsuffix("MyApp.User", "View")
      "MyApp.User"

      iex> Horn.Naming.unsuffix("MyApp.UserView", "View")
      "MyApp.User"
  ...
  ## Examples
      ...
      iex> Horn.Naming.underscore("MyApp")
      "my_app"

  In general, `underscore` can be thought of as the reverse of
  `camelize`, however, in some cases formatting may be lost:

      Horn.Naming.underscore "SAPExample"  #=> "sap_example"
      Horn.Naming.camelize   "sap_example" #=> "SapExample"
  ...
  ## Examples
      ...
      iex> Horn.Naming.camelize("my_app")
      "MyApp"

      iex> Horn.Naming.camelize("my_app", :lower)
      "myApp"
  ...
  ## Examples
      ...
      iex> Horn.Naming.humanize(:username)
      "Username"
      iex> Horn.Naming.humanize(:created_at)
      "Created at"
      iex> Horn.Naming.humanize("user_id")
      "User"
