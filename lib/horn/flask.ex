defmodule Horn.New.Flask do
  ...
  template(:app, [
    ...
    {:eex, "horn_app/config/__init__.py", :project, ":app/config/__init__.py"},
    {:eex, "horn_app/config/default.py", :project, ":app/config/default.py"},
    {:eex, "horn_app/config/development.py", :project, ":app/config/development.py"},
    {:eex, "horn_app/config/production.py", :project, ":app/config/production.py"},
    {:eex, "horn_app/config/testing.py", :project, ":app/config/testing.py"},
